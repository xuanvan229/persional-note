(function (global, factory) {
	...
	Viewer.prototype = Object.assign( Object.create( THREE.EventDispatcher.prototype ), {
	     ...
	     */
	    animate: function () {
					// console.log("animate", this.camera.rotation.y);
	    ...
	    addViewIndicator: function () {
	        ...
	        function loadViewIndicator ( asyncEvent ) {
	            ...
	            viewIndicatorDiv.style.top = '10';
	            viewIndicatorDiv.style.left = '10px';
							viewIndicatorDiv.style.opacity = '0.5';
							viewIndicatorDiv.style.zIndex='10';
	            ...
	            const setIndicatorD = function () {
									// console.log("scope.camera.rotation.y", scope.camera)
	                scope.radius = scope.viewIndicatorSize * 0.225;
									scope.currentPanoAngle = scope.camera.rotation.y - THREE.Math.degToRad( 90 );
									// console.log("currentPanoAngle", scope.currentPanoAngle)
