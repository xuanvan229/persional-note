...
export const sendRegister = (data, toast) => ({
  type: actionType.REGISTER_SEND_REQUEST,
  payload: {data , toast},
});

export const receiveRegisterSuccess = data => ({
  type: actionType.REGISTER_SEND_REQUEST_SUCCESS,
  payload: { data },
});

export const receiveRegisterFail = error => ({
  type: actionType.REGISTER_SEND_REQUEST_FAILED,
  payload: { error },
});
...
export const nonrefreshToken = () => ({
  type: actionType.NON_REFRESH_TOKEN
})
